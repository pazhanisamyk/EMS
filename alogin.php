	...
	<header>
		<nav><center><font face="times new roman" size="5" color="white">
			<h1>Welcome To Employee Management System</h1>						
				<a  href="index.php"><b><font color="white">HOME</font></b></a>
				&nbsp;&nbsp;
				<a  href="elogin.php"><b><font color="white">Employee Login</font></b></a>
				&nbsp;&nbsp;
				<a  href="alogin.php"><b><font color="black">Admin Login</font></b></a>
			</font>
			</center>
		</nav>
	</header>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <img src="assets/admin.png" class="avatar" height="20%" width="20%">
                                    </div>
