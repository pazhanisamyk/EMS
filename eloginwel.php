...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				<li><a class="homered" href="eloginwel.php?id=<?php echo $id?>"><font face="times new Roman"><b>HOME</a></b></font></li>
				<li><a class="homeblack" href="myprofile.php?id=<?php echo $id?>"><font face="times new Roman"><b>My Profile</a></b></font></li>
				<li><a class="homeblack" href="empproject.php?id=<?php echo $id?>"><font face="times new Roman"><b>My Projects</a></b></font></li>
				<li><a class="homeblack" href="applyleave.php?id=<?php echo $id?>"><font face="times new Roman"><b>Apply Leave</a></b></font></li>
				<li><a class="homeblack" href="elogin.php"><font face="times new Roman"><b>Log Out</a></b></font></li>
			</ul>
		</nav>
	</header>
	...
	<div>
		    	...
		    	<h2 style="font-family: 'Montserrat', times new roman; font-size: 25px; text-align: center;">Empolyee Leaderboard </h2>
    	<table>
    	...
    	<h2 style="font-family: 'times new roman', sans-serif; font-size: 25px; text-align: center;">Due Projects</h2>
